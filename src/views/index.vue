    ...
    <div class="bg">
            ...
            <flexbox-item>
              <div class="wrap">
                ...
                <button class="btn" @click="toRouterActiveRule">活动规则 <img class="btn-img"
                                                                          src="../assets/img/rightbtn.png" alt="">
                </button>
              </div>
            </flexbox-item>
          </flexbox>
      ...
      <div class="operation">
        <div class="operation-page">
          ...
          <button @click="toRouter('price')" class="btn operation-btn"><img src="../assets/img/gift.png" width="47px"
                                                                            alt=""></button>
        </div>
        <div class="user-operation">
          ...
          <div class="guess-btn" v-show="!status">
            <button @click="lookUpDown('up')" class="btn guess-sub-btn"><img width="100%" src="../assets/img/redbtn.png"
                                                                             alt=""></button>
            <button @click="lookUpDown('down')" class="btn"><img width="100%" src="../assets/img/greenbtn.png" alt="">
            </button>
          </div>
    ...
    <div v-transfer-dom>
      <x-dialog v-model="showDialog" hide-on-blur
        ...
        <div class="dialog-wrap"
          ...
          <p style="display: flex;justify-content: space-between;margin:30px 0 15px;"><span style="color: #78BAEC">每次预言扣除2积分手续费</span><span
            style="color: #fff">我的积分:22222222</span></p>
          ...
          <button @click="sureGuess('up')" v-if="statusUpDown=='up'"
          ...
          <button @click="sureGuess('down')" v-if="statusUpDown!=='up'"
                  style="margin-top: 33px;padding:0;width: 100%;height: 65px;background: none;border:0;"><img
      ...
      <x-dialog v-model="showDialogGlodEgg" hide-on-blur
        ...
        <div style="width:100%;height:100%;">
          ...
          <div
            ...
            <button @click="sureClose" style="background: none;border:0;padding:0;margin-top:32px;"><img width="100%"
